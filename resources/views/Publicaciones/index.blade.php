...
@section('content')
<div class="container">
    <h1 class="text-center text-warning">Publicaciones</h1>
                    ...
                    <div class="accordion-body">
                        <div class="d-flex justify-content-between"
                            <tr>
                                ...
                                <th><a href="{{route('publicaciones.borrarPublicacion', [$pub->id] )}}" role="button" class="btn btn-light" title="Eliminar Publicación"><i class="fa fa-trash" style="color:slategray" ></i></a>
                                </th>
                                <th><a href="{{route('publicaciones.edit', [$pub->id] )}}" role="button" class="btn btn-light" title="Editar Publicación"><i class="fas fa-edit" style="color:cadetblue" ></i></a>
                                </th>
                                @endif
                                <th><a href="{{route('publicaciones.mostrarpdf', [$pub->id] )}}" role="button" class="btn btn-light" title="Mostrar Publicación"><i class="fas fa-file-pdf" style="color:palevioletred" ></i></a>
                                </th>
                                </div>
                            </tr>
                        </div>
